.class public Lcom/cdv/effect/utils/NvAndroidPlatformImage;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/cdv/effect/utils/NvAndroidPlatformImage;->m_renderScript:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public static blurTo(Landroid/content/Context;Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;F)V
    ...
    :try_start_0
    invoke-static {p0}, Lcom/cdv/effect/utils/NvAndroidPlatformImage;->getRednerScriptContext(Landroid/content/Context;)Landroid/renderscript/RenderScript;

    move-result-object p0

    if-nez p0, :cond_0

    invoke-static {p1, p2, p4}, Lcom/cdv/effect/utils/NvAndroidPlatformImage;->copyTo(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/Bitmap;)V
    ...
    .line 2
    invoke-static {p0, p1, p2}, Lcom/cdv/effect/text/NvAndroidFont$$ExternalSyntheticOutline0;->m(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public static drawBitmap(Landroid/graphics/Canvas;Landroid/graphics/Paint;ILandroid/graphics/Bitmap;IIIIFFFF)V
    ...
    :try_start_0
    invoke-static {p2}, Lcom/cdv/effect/utils/NvAndroidPlatformImage;->getXferMode(I)Landroid/graphics/Xfermode;
...
.method private static getRednerScriptContext(Landroid/content/Context;)Landroid/renderscript/RenderScript;
    ...
    :try_start_0
    sget-object v1, Lcom/cdv/effect/utils/NvAndroidPlatformImage;->m_renderScript:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sget-object p0, Lcom/cdv/effect/utils/NvAndroidPlatformImage;->m_renderScript:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 2
    invoke-static {p0, v1, v2}, Lcom/cdv/effect/text/NvAndroidFont$$ExternalSyntheticOutline0;->m(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
