...
.method public static getCamAlignedSensor()Landroid/hardware/Sensor;
    .locals 2
    ...
    invoke-static {v0, v1}, Lcom/motorola/camera/shared/Util;->getCamAlignedSensor(Landroid/hardware/SensorManager;I)Landroid/hardware/Sensor;
...
.method public static loadThumbnailByMediaStore(JILandroid/net/Uri;)Landroid/graphics/Bitmap;
    .locals 10
    ...
    .line 4
    invoke-virtual {v2, p2, p3}, Landroid/media/MediaMetadataRetriever;->setDataSource(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 6
    invoke-virtual {v2, p3}, Landroid/media/MediaMetadataRetriever;->extractMetadata(I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v6}, Landroid/media/MediaMetadataRetriever$BitmapParams;->setPreferredConfig(Landroid/graphics/Bitmap$Config;)V
...
.method public static loadThumbnailByTargetSize(Lcom/motorola/camera/CameraData;Landroid/util/Size;)Landroid/graphics/Bitmap;
    ...
    .line 19
    invoke-static {v3, v4, v1, v0}, Lcom/motorola/camera/Util;->loadThumbnailByMediaStore(JILandroid/net/Uri;)Landroid/graphics/Bitmap;
