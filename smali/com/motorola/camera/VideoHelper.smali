...
.method public static constructor <clinit>()V
    ...
    sget-object v5, Lcom/motorola/camera/VideoFormat;->UHD_4K:Landroid/util/Size;
    ...
    new-array v7, v2, [Landroid/util/Size;

    .line 8
    sget-object v8, Lcom/motorola/camera/VideoFormat;->UHD_4K_21V9:Landroid/util/Size;

    aput-object v8, v7, v4

    sget-object v9, Lcom/motorola/camera/VideoFormat;->FHD_21V9:Landroid/util/Size;

    aput-object v9, v7, v6

    sget-object v10, Lcom/motorola/camera/VideoFormat;->FHD_21V9_2:Landroid/util/Size;
    ...
    sput-object v7, Lcom/motorola/camera/VideoHelper;->ANAMORPHIC_VIDEO_SIZES:Ljava/util/List;
    ...
    .line 11
    sget-object v12, Lcom/motorola/camera/VideoFormat;->UHD_8K:Landroid/util/Size;

    aput-object v12, v11, v4

    sget-object v4, Lcom/motorola/camera/VideoFormat;->UHD_8K_20V9:Landroid/util/Size;
    ...
    sget-object v1, Lcom/motorola/camera/VideoFormat;->UHD_6K:Landroid/util/Size;

    aput-object v1, v11, v2

    sget-object v1, Lcom/motorola/camera/VideoFormat;->UHD_6K_39V18:Landroid/util/Size;

    const/4 v2, 0x4

    aput-object v1, v11, v2

    sget-object v1, Lcom/motorola/camera/VideoFormat;->UHD_6K_21V9:Landroid/util/Size;

    const/4 v2, 0x5

    aput-object v1, v11, v2

    sget-object v1, Lcom/motorola/camera/VideoFormat;->UHD_5K:Landroid/util/Size;
    ...
    sget-object v1, Lcom/motorola/camera/VideoFormat;->EQU_4K:Landroid/util/Size;

    const/16 v2, 0x8

    aput-object v1, v11, v2

    sget-object v1, Lcom/motorola/camera/VideoFormat;->UHD_4K_19V9:Landroid/util/Size;

    const/16 v2, 0x9

    aput-object v1, v11, v2

    sget-object v1, Lcom/motorola/camera/VideoFormat;->UHD_4K_19P5V9:Landroid/util/Size;

    const/16 v2, 0xa

    aput-object v1, v11, v2

    sget-object v1, Lcom/motorola/camera/VideoFormat;->UHD_4K_20V9:Landroid/util/Size;

    const/16 v2, 0xb

    aput-object v1, v11, v2

    sget-object v1, Lcom/motorola/camera/VideoFormat;->UHD_4K_20P5V9:Landroid/util/Size;
    ...
    sget-object v1, Lcom/motorola/camera/VideoFormat;->UHD_4K_21V9_2:Landroid/util/Size;

    const/16 v2, 0xe

    aput-object v1, v11, v2

    sget-object v1, Lcom/motorola/camera/VideoFormat;->UHD_4K_21V9_3:Landroid/util/Size;

    const/16 v2, 0xf

    aput-object v1, v11, v2

    sget-object v1, Lcom/motorola/camera/VideoFormat;->UHD_4K_22V9:Landroid/util/Size;

    const/16 v2, 0x10

    aput-object v1, v11, v2

    sget-object v1, Lcom/motorola/camera/VideoFormat;->EQU_FHD:Landroid/util/Size;
    ...
    invoke-static {v7, v11}, Ljava/util/Collections;->addAll(Ljava/util/Collection;[Ljava/lang/Object;)Z
...
.method public static getFilteredVideoFormats(Ljava/util/List;Ljava/util/List;I)Ljava/util/List;
    ...
    sget-object v9, Lcom/motorola/camera/VideoFormat;->UHD_8K:Landroid/util/Size;
