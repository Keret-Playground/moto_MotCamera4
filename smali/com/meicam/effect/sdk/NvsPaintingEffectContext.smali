.class public Lcom/meicam/effect/sdk/NvsPaintingEffectContext;
...
.method private native nativeSetStrokeGradient(JLcom/meicam/effect/sdk/NvsColor;)V
.end method
...
.method public AddStroke([F)V
    ...
    iget-wide v0, p0, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->m_contextInterface:J

    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeAddStroke(J[F)V
...
.method public AppendStroke([F)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeAppendStroke(J[F)V
...
.method public RemoveAllStroke()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeRemoveAllStroke(J)V
...
.method public RemoveLastStroke()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeRemoveLastStroke(J)V
...
.method public SetStrokeAnalogAmplitude(F)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeAnalogAmplitude(JF)V
...
.method public SetStrokeAnalogPeriod(F)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeAnalogPeriod(JF)V
...
.method public SetStrokeAnalogType(I)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeAnalogType(JI)V
...
.method public SetStrokeAnimated(Z)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeAnimated(JZ)V
...
.method public SetStrokeAnimationSpeed(F)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeAnimationSpeed(JF)V
...
.method public SetStrokeCapStyle(I)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeCapStyle(JI)V
...
.method public SetStrokeFillMode(I)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeFillMode(JI)V

    return-void
.end method

.method public SetStrokeGradient(Lcom/meicam/effect/sdk/NvsColor;)V
    .locals 2
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeGradient(JLcom/meicam/effect/sdk/NvsColor;)V
...
.method public SetStrokeJointStyle(I)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeJointStyle(JI)V
...
.method public SetStrokeTextureFilePath(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeTextureFilePath(JLjava/lang/String;)V
...
.method public SetStrokeTextureRepeatTimes(II)V
    ...
    invoke-direct {p0, v0, v1, p1, p2}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeTextureRepeatTimes(JII)V
...
.method public SetStrokeTextureWarpType(I)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeTextureWarpType(JI)V
...
.method public SetStrokeWidth(F)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeSetStrokeWidth(JF)V
...
.method public finalize()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->nativeCleanup(J)V

    iput-wide v2, p0, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->m_contextInterface:J
...
.method public setContextInterface(J)V
    ...
    iput-wide p1, p0, Lcom/meicam/effect/sdk/NvsPaintingEffectContext;->m_contextInterface:J
