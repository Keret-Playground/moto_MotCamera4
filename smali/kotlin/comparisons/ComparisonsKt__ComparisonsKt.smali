...
# static fields
.field public static final INSTANCE:Lkotlin/comparisons/ComparisonsKt__ComparisonsKt;
...
.method static synthetic constructor <clinit>()V
    ...
    new-instance v0, Lkotlin/comparisons/ComparisonsKt__ComparisonsKt;

    invoke-direct {v0}, Lkotlin/comparisons/ComparisonsKt__ComparisonsKt;-><init>()V

    sput-object v0, Lkotlin/comparisons/ComparisonsKt__ComparisonsKt;->INSTANCE:Lkotlin/comparisons/ComparisonsKt__ComparisonsKt;
...
.method public isClassType(Lkotlin/reflect/jvm/internal/impl/types/model/SimpleTypeMarker;)Z
    ...
    .line 2
    invoke-virtual {p0, p1}, Lkotlin/comparisons/ComparisonsKt__ComparisonsKt;->typeConstructor(Lkotlin/reflect/jvm/internal/impl/types/model/SimpleTypeMarker;)Lkotlin/reflect/jvm/internal/impl/types/model/TypeConstructorMarker;

    move-result-object p1

    invoke-virtual {p0, p1}, Lkotlin/comparisons/ComparisonsKt__ComparisonsKt;->isClassTypeConstructor(Lkotlin/reflect/jvm/internal/impl/types/model/TypeConstructorMarker;)Z
...
.method public isIntegerLiteralType(Lkotlin/reflect/jvm/internal/impl/types/model/SimpleTypeMarker;)Z
    ...
    invoke-virtual {p0, p1}, Lkotlin/comparisons/ComparisonsKt__ComparisonsKt;->isIntegerLiteralTypeConstructor(Lkotlin/reflect/jvm/internal/impl/types/model/TypeConstructorMarker;)Z
...
.method public typeConstructor(Lkotlin/reflect/jvm/internal/impl/types/model/KotlinTypeMarker;)Lkotlin/reflect/jvm/internal/impl/types/model/TypeConstructorMarker;
    ...
    .line 2
    invoke-virtual {p0, p1}, Lkotlin/comparisons/ComparisonsKt__ComparisonsKt;->asSimpleType(Lkotlin/reflect/jvm/internal/impl/types/model/KotlinTypeMarker;)Lkotlin/reflect/jvm/internal/impl/types/model/SimpleTypeMarker;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, Lkotlin/comparisons/ComparisonsKt__ComparisonsKt;->lowerBoundIfFlexible(Lkotlin/reflect/jvm/internal/impl/types/model/KotlinTypeMarker;)Lkotlin/reflect/jvm/internal/impl/types/model/SimpleTypeMarker;

    move-result-object v0

    :cond_0
    invoke-virtual {p0, v0}, Lkotlin/comparisons/ComparisonsKt__ComparisonsKt;->typeConstructor(Lkotlin/reflect/jvm/internal/impl/types/model/SimpleTypeMarker;)Lkotlin/reflect/jvm/internal/impl/types/model/TypeConstructorMarker;
